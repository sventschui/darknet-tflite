...
def preprocess_image(
...
) -> Tuple[np.ndarray, float, Tuple[int, int], Any]:
    """
    ...
    Returns:
        Preprocessed image as numpy array, scale ratio, and padding offsets (pad_x, pad_y), OpenCV image (RGB, resized)
    """
    ...
    return image_input, scale, (pad_x, pad_y), image_rgb
